...
function setup() 
{
 ...
 star1 = createSprite(300,40,50,50);
...
function draw() 
{
  ...
  image(bg_img,0,0,width,height);
   ...
   star1.visible = false
   starDisplay.changeAnimation("1star", oneStar)
    ...
    star2.visible = false
    starDisplay.changeAnimation("2stars", twoStar)
